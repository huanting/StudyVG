...
public class MgShapeDoc extends MgObject {
  ...
  public int copyShapes(MgShapeDoc src, boolean deeply, boolean needClear) {
    return touchvgJNI.MgShapeDoc_copyShapes__SWIG_0(swigCPtr, this, MgShapeDoc.getCPtr(src), src, deeply, needClear);
  }

  public int copyShapes(MgShapeDoc src, boolean deeply) {
    return touchvgJNI.MgShapeDoc_copyShapes__SWIG_1(swigCPtr, this, MgShapeDoc.getCPtr(src), src, deeply);
  }
