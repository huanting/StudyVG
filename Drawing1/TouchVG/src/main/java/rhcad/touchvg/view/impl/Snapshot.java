...
public class Snapshot {
    public static int SAVE_IMG_WIDTH = 1920;
    public static int SAVE_IMG_HEIGHT = 1080;
    ...
    public static Bitmap snapshot(BaseGraphView view, boolean transparent) {
        ...
        try {
            ...
            log.r(bitmap != null ? bitmap.getRowBytes() : 0);
            return bitmap;
        } finally {
    ...
    public static Bitmap extentSnapshot(BaseGraphView view, int spaceAround, boolean transparent) {
        ...
        synchronized (v) {
            v.onSize(view.viewAdapter(), Snapshot.SAVE_IMG_WIDTH, Snapshot.SAVE_IMG_HEIGHT);
            v.zoomToExtent(0);
...
//                extent.width(), extent.height());
        ...
        final Bitmap realBitmap = Bitmap.createBitmap(viewBitmap, 0, 0, viewBitmap.getWidth(), viewBitmap.getHeight());

        viewBitmap.recycle();
        log.r(realBitmap.getRowBytes());
        return realBitmap;
    }
