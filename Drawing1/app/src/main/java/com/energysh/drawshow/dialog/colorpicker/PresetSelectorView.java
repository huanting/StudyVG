...
public class PresetSelectorView extends LinearLayout {
	...
	private static int MAXIMUM_COLOR_BUTTONS_IN_COLOR_ROW = 6;
	private TableLayout mTableLayout;
	private int COLOR_BUTTON_MARGIN = 3;
	...
	private void init(Context context) {
		...
		{
			MAXIMUM_COLOR_BUTTONS_IN_COLOR_ROW = 6;
			colorButtonLayoutParameters.height = (int) getResources().getDimension(R.dimen.layy50);
		}
		else
		{
			MAXIMUM_COLOR_BUTTONS_IN_COLOR_ROW = 5;
			colorButtonLayoutParameters.height = (int)getResources().getDimension(R.dimen.layy50);
			colorButtonLayoutParameters.width = (int)getResources().getDimension(R.dimen.layy50);
		}
