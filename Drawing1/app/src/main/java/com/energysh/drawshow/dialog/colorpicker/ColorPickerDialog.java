...
import com.energysh.drawshow.dialog.BaseDialog;
...
public final class ColorPickerDialog extends BaseDialog {
	...
	private RgbSelectorView mRGBSelectorView; //rgb selector
	private PresetSelectorView mPreSelectorView; //grid color chooser
	private RectColorPickerView mRectClrPicker; //color rect chooser
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mRGBSelectorView = (RgbSelectorView)findViewById(R.id.rgb_selector_view);
		mRGBSelectorView
		...
		mPreSelectorView =(PresetSelectorView)findViewById(R.id.preset_selector_view);
		mPreSelectorView
		...
		mRectClrPicker = (RectColorPickerView)findViewById(R.id.color_picker_view);
		mRectClrPicker.setOnColorChangedListener(new RectColorPickerView.OnColorChangedListener() {
			@Override
	...
	public void setSelectedColor(int color)
	{
		...
		mRectClrPicker.setColor(color);
		onColorChanged();
	}

	private void onColorChanged() {
		changeNewColor(mSelectedColor);
		updateColorChange(mSelectedColor);
	}
}
