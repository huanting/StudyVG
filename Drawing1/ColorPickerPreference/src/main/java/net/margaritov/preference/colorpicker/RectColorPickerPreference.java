 ...
 */
public class RectColorPickerPreference
        extends
        Preference
        implements
        Preference.OnPreferenceClickListener,
        RectColorPickerDialog.OnColorChangedListener {

    View mView;
    RectColorPickerDialog mDialog;
    private int mValue = Color.BLACK;
    private float mDensity = 0;
    private boolean mAlphaSliderEnabled = false;
    private boolean mHexValueEnabled = false;

    public RectColorPickerPreference(Context context) {
        super(context);
        init(context, null);
    }

    public RectColorPickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RectColorPickerPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void showDialog(Bundle state) {
        mDialog = new RectColorPickerDialog(getContext(), mValue);
